...
function generateTestCurrentPackage() {
    ...
    return generateTests({ dir: path.dirname(editor.document.uri.fsPath) }, util_1.getGoConfig(editor.document.uri));
}
...
function generateTestCurrentFile() {
    ...
    return generateTests({ dir: editor.document.uri.fsPath }, util_1.getGoConfig(editor.document.uri));
}
...
function generateTestCurrentFunction() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return generateTests({ dir: editor.document.uri.fsPath, func: funcName }, util_1.getGoConfig(editor.document.uri));
    });
}
